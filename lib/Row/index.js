...
module.exports = React.createClass({
  ...
  render: function render() {
    ...
    var cellFactory = props.cellFactory,
        ...
        rest = _objectWithoutProperties(props, ['cellFactory', 'renderCell', 'renderText', 'rowHeight', 'minWidth', 'rowContextMenu', 'showMenu', '_onClick', 'selectable', 'index', 'columns', 'defaultStyle']);
